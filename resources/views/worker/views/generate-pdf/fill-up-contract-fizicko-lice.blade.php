                    ...
                    <div class="text-lg lg:text-justify">
                        <p class="mb-10">
                            ...
                            <input type="text" style="border-radius: 0px !important;" class="w-60" name="field2"
                                value="{{ $foundClient->last_name }}"> {{ __('iz') }} 
                            <input type="text" style="border-radius: 0px !important;" name="field3"
                                value="{{ $foundClient->city }}">,
                                {{ __('adresa') }}:<input type="text" style="border-radius: 0px !important;" name="field4"
                        ...
                        <p>
                            ...
                            {{ __('adresa') }}:<input type="text" style="border-radius: 0px !important;" name="field7"
                                value="{{ $company_data->address }}">, 
                            {{ __('PIB') }}:<input type="text" style="border-radius: 0px !important;" class="w-52"
                                name="field8" value="{{ $company_data->pib }}"> {{ __('s druge strane, koje zastupa direktor') }} 
                            <input type="text"
                                style="border-radius: 0px !important;" name="field9"> 
                            {{ __('iz') }} <input type="text" style="border-radius: 0px !important;" name="field10">, {{ __('kao izvođača (u daljem tekstu: Izvođač)') }}.
                        </p>
                        <p class="my-10">
                        ...
                        <p class="mb-10">
                            ...
                            {{ __('ul.') }}<input type="text" style="border-radius: 0px !important;" name="field12"> 
                            {{ __('br.') }}<input type="text" style="border-radius: 0px !important;" name="field13"
                                class="w-32"> 
                        ...
                        <p class="mb-10">
                            ...
                            <input type="text" style="border-radius: 0px !important;" class="w-20"
                                name="field23"> 
                            {{ __('primerka nalaze kod Naručioca, a') }} <input type="text" style="border-radius: 0px !important;" class="w-20"
                                name="field24"> 
