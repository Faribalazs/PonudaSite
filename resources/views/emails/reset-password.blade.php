...
<div class="main-div">
    <div class="secondary-div">
        <div class="white-div">
            ...
            <div class="btn-div">
                {{$url}}
                <a class="verify-btn" href="{{route('password.reset', ['token'=> $url, 'email' => $notifiable->getEmailForPasswordReset()])}}" >{{__('app.email.reset-password-btn-text')}}</a>
            </div>
            <div class="text-div" style="margin-bottom: 35px;">
                <span class="text-content">{{__('app.email.reset-password-expire')}}</span>
            </div>
            <div class="text-div">
