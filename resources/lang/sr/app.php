...
return [
    ...
    'create-ponuda' => [
        ...
        'choose-work-type'              => "Odaberi vrstu rada",
    ...
    'categories' => [
        ...
        'choose-option'                 => "Dodaj svoju vrstu rada/kategoriju/podkategoriju/poziciju radova koju ćeš koristiti za izradu ponude:",
        'dodaj'                         => "Dodaj",
        'new-work-type'                 => "Novu vrstu rada",
        'new-category'                  => "Novu kategoriju",
        'new-subcategory'               => "Novu podkategoriju",
        'new-pozicija'                  => "Novu poziciju",
        'new-work-type-title'           => "Nova vrsta rada",
        ...
        'update-work-type'              => "Ažuriraj vrstu rada",
        'write-name-work-type'          => "Upiši naziv vrste rada",
